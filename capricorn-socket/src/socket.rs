...
impl Handler<CMessage> for CapricornServer {
    type Result = ();
...
impl Actor for CapricornServer {
    type Context = Context<Self>;
}

impl Handler<Connect> for CapricornServer {
    type Result = usize;
...
impl Handler<Disconnect> for CapricornServer {
    type Result = ();
